Shader "MonsterSupergroup/PlanarSummonShadow"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "GameplayPlanarProjection.hlsl"
            sampler2D _MainTex;
            fixed4 _Color;
            ...
            {
                Varyings output;
                output.vertex = mul(UNITY_MATRIX_VP, float4(GameplayPlanarWorld(mul(unity_ObjectToWorld, input.vertex).xyz), 1));
                output.uv = input.uv;
