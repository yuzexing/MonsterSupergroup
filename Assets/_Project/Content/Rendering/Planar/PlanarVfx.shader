// Adapted copy: AllIn1 VFX URP compatibility. Original plugin remains unchanged.
Shader "MonsterSupergroup/PlanarVfx"
{
    Properties
    {
        [HideInInspector] _GameplayPlanar("Gameplay XY projection", Float) = 1
		...
		// Compatibility properties serialized by the decompiled AllIn1VfxURP materials.
		_FlipU("Flip U", Float) = 0
		_IsCoveredByGround("Is Covered By Ground", Float) = 0
		_IsCoveredByObject("Is Covered By Object", Float) = 0
		_IsCoveredByUnit("Is Covered By Unit", Float) = 0
		_IsShear("Is Shear", Float) = 0
		_MinRenderHeight("Min Render Height", Float) = -1000
		_NotUseSceneDepth("Not Use Scene Depth", Float) = 0
		_ShearBase("Shear Base", Float) = 0
	...
	SubShader
	{
		...
		Pass
        {
			...
			#include_with_pragmas "Assets/Plugins/AllIn1VfxToolkit/Shaders/ShaderLibrary/AllIn1VfxSRPBatch_ShaderFeatures.hlsl"
			...
			#include "Assets/Plugins/AllIn1VfxToolkit/Shaders/ShaderLibrary/AllIn1VfxSRPBatch_HDRPHelper.hlsl"
			#include "Assets/Plugins/AllIn1VfxToolkit/Shaders/ShaderLibrary/AllIn1VfxSRPBatch_CommonFunctions.hlsl" 

			#include "Assets/Plugins/AllIn1VfxToolkit/Shaders/ShaderLibrary/AllIn1VfxSRPBatch_Structs.hlsl"
			#include "Assets/_Project/Content/Rendering/Planar/PlanarVfxBuffers.hlsl"

			#include "Assets/_Project/Content/Rendering/Planar/PlanarVfxVertex.hlsl"
			#include "Assets/Plugins/AllIn1VfxToolkit/Shaders/ShaderLibrary/AllIn1VfxSRPBatch_FragmentPass.hlsl"
    ...
    {	
        ...
        Pass
        {
			...
			#include "Assets/Plugins/AllIn1VfxToolkit/Shaders/ShaderLibrary/AllIn1VfxSRPBatch_URPHelper.hlsl"
			#include "Assets/Plugins/AllIn1VfxToolkit/Shaders/ShaderLibrary/AllIn1VfxSRPBatch_CommonFunctions.hlsl" 
