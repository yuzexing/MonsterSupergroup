...
namespace MonsterSupergroup.NetworkCombat
{
    ...
    public sealed partial class LimboReferenceLaunch : MonoBehaviour
    {
        ...
        private static void Install()
        {
            ...
            if (Profile.StartsWith("ghoul", StringComparison.Ordinal)) { runner.gameObject.AddComponent<LimboGhoulObservation>(); runner.gameObject.AddComponent<LimboStage2Observation>(); runner.gameObject.AddComponent<LimboSpatialObservation>(); }
