...
& (Join-Path $PSScriptRoot 'Start-Case.ps1') -PackageDirectory $PackageDirectory -OutputRoot $OutputRoot -Role Client -Mode local -Stage chain -EvidenceProfile $EvidenceProfile -ObserveEvidenceQueue:$ObserveEvidenceQueue
