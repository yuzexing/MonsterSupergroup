...
& (Join-Path $PSScriptRoot 'Start-Case.ps1') -PackageDirectory $PackageDirectory -OutputRoot $OutputRoot -Role Client -Mode off -Stage network -EvidenceProfile Standard
