...
**后续接入更新（2026-09-15）：** LostSoul E8 与 Ghoul E9 原始身体已接入；Ghoul 新增 19 个独立身体动画，按嵌套 attackSets 恢复第三击特殊绑定。当前累计 9 套身体、17 种外观/变体组合、425 项依赖（103 动画、17 视觉模板、25 材质、211 Sprite、64 纹理、5 Shader 映射）。依赖审计确认来源未修改、目标齐全；11 份换色输出沿用此前双次一致记录，Ghoul v0 无新增变体换色。当前构建 `Builds/LimboGhoul20260915` 完成 599.966666… 秒单人/双端技术运行及 GUI 重开，详见 [Ghoul 验收报告](limbo-ghoul-integration.md)。[LostSoul 记录](limbo-lostsoul-integration.md) 和下面七套身体、325 项依赖、身体暂缓的描述均为历史范围。原 Shader 差异继续保留。
