...
## Windows UI Automation 退出故障补充

2026-09-13 的 D3D11 首页退出已取得另一组无障碍服务生命周期证据，正以 Unity 6000.3.21f1 的 UUM-146676 修复进行隔离升级验证，见 [UI Automation 退出修复记录](windows-uia-exit-fix.md)。该结果与本文 D3D12 PSO 缓存故障分别记录。
